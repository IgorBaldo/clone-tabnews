...
describe("PATCH /api/v1/users/[username]", () => {
  ...
  describe("Default user", () => {
    ...
    test("With duplicated 'username'", async () => {
      ...
      expect(responseBody).toEqual({
        ...
        message: "O username informado já está utilizado.",
    ...
    test("With duplicated 'email'", async () => {
      ...
      expect(responseBody).toEqual({
        name: "ValidationError",
        message: "O email informado já está utilizado.",
  ...
  describe("Privileged user", () => {
    test("With 'update:user:others' targeting 'defaultUser'", async () => {
      ...
      const activatedPrivilegedUserSession = await orchestrator.createSession(
      ...
      const response = await fetch(
        `http://localhost:3000/api/v1/users/${defaultUser.username}`,
        {
          ...
          headers: {
            "Content-Type": "application/json",
            Cookie: `session_id=${activatedPrivilegedUserSession.token}`,
          },
          body: JSON.stringify({
